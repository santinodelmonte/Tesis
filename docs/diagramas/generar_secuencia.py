...
PANTALLAS = {
    ...
    10: ['PagesAnimal/BuscarAnimales'],
    11: ['PagesAnimal/DetalleAnimal'],
    12: ['PagesProduccion/OrdenieLote'],
    13: ['PagesProduccion/ControlLechero'],
    14: ['PagesProduccion/HistorialProduccion'],
    ...
    19: ['PagesProduccion/ModificarOrdenieLote'],
